    ...
    public struct VPN {
        ...
        public static let yearlySubDetail =
            NSLocalizedString("vpn.yearlySubDetail",
                              bundle: .braveShared,
                              value: "Renew annualy save %@",
                              comment: "Used in context: 'yearly subscription, renew annualy (to) save 16%'. The placeholder is for percent value")
        ...
        public static let checkboxProtectConnections =
            NSLocalizedString("vpn.checkboxProtectConnections",
                              bundle: .braveShared,
                              value: "Protects all connections",
                              comment: "Text for a checkbox to present the user benefits for using Brave VPN")
        ...
        public static let checkboxNoIPLog =
            NSLocalizedString("vpn.checkboxNoIPLog",
                              bundle: .braveShared,
                              value: "Keep your IP address secret",
                              comment: "Text for a checkbox to present the user benefits for using Brave VPN")
        
        public static let checkboxEncryption =
            NSLocalizedString("vpn.checkboxEncryption",
                              bundle: .braveShared,
                              value: "IKEv2 secure tunnel encrypted with AES-256",
                              comment: "Text for a checkbox to present the user benefits for using Brave VPN")
        
        public static let checkboxPrivateID =
            NSLocalizedString("vpn.checkboxPrivateID",
                              bundle: .braveShared,
                              value: "Totally private random identity and credentials",
                              comment: "Text for a checkbox to present the user benefits for using Brave VPN")
        
        public static let checkboxWhoAreYou =
        ...
        public static let contactFormIssueOtherAppsDontWork =
            NSLocalizedString("vpn.contactFormIssueOtherAppsDontWork",
                              bundle: .braveShared,
                              value: "App doesn't work(Not Brave)",
                              comment: "App doesn't work problem for contact form issue field.")
        ...
        public static let contactFormIssueConnectionReliability =
            NSLocalizedString("vpn.contactFormIssueConnectionReliability",
                              bundle: .braveShared,
                              value: "Connection rreliability problem",
