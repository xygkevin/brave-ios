...
private class ContentView: UIView {
    ...
    private let backgroundImage = UIImageView(image: #imageLiteral(resourceName: "vpn_callout_background")).then {
    ...
    override init(frame: CGRect) {
        ...
        [titleStackView, checkboxesStackView, enableButtonStackView]
